...
The site works as a progressive web app. Visit once and you can install it for offline access — useful if your studio doesn't have great wifi.
...
If you spot a missing shortcut or something that doesn't match your experience with the device, feel free to open an issue.
